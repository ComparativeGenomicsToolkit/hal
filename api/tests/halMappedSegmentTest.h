...
struct MappedSegmentMapUpTest : virtual public AlignmentTest {
    ...
    void testTopSegment(const Alignment *alignment, TopSegmentIteratorPtr top, const std::string &ancName);
};
...
struct MappedSegmentMapDownTest : public MappedSegmentMapUpTest {
    ...
    void testBottomSegment(const Alignment *alignment, BottomSegmentIteratorPtr bottom, hal_size_t childIndex);
};
