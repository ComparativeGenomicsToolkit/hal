...
void TopSegmentStruct::set(hal_index_t startPosition, hal_size_t length, hal_index_t parentIndex, bool parentReversed,
                           hal_index_t bottomParseIndex, hal_index_t nextParalogyIndex) {
