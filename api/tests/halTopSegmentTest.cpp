...
static void halTopSegmentSimpleIteratorTest(CuTest *testCase) {
    TopSegmentSimpleIteratorTest tester;
    tester.check(testCase);
}

static void halTopSegmentSequenceTest(CuTest *testCase) {
    TopSegmentSequenceTest tester;
    tester.check(testCase);
}

static void halTopSegmentIteratorParseTest(CuTest *testCase) {
    TopSegmentIteratorParseTest tester;
    tester.check(testCase);
}

static void halTopSegmentIteratorToSiteTest(CuTest *testCase) {
    TopSegmentIteratorToSiteTest tester;
    tester.check(testCase);
}

static void halTopSegmentIteratorReverseTest(CuTest *testCase) {
    TopSegmentIteratorReverseTest tester;
    tester.check(testCase);
}

static void halTopSegmentIsGapTest(CuTest *testCase) {
    TopSegmentIsGapTest tester;
    tester.check(testCase);
}

static CuSuite *halTopSegmentTestSuite(void) {
...
int main(int argc, char *argv[]) {
    return runHalTestSuite(argc, argv, halTopSegmentTestSuite());
}
