...
void MappedSegmentMapUpTest::testTopSegment(const Alignment *alignment, TopSegmentIteratorPtr top, const string &ancName) {
...
void MappedSegmentParseTest::testTopSegment(const Alignment *alignment, TopSegmentIteratorPtr top) {
...
void MappedSegmentMapDownTest::testBottomSegment(const Alignment *alignment, BottomSegmentIteratorPtr bottom,
...
void MappedSegmentMapAcrossTest::testTopSegment(const Alignment *alignment, TopSegmentIteratorPtr top) {
...
void MappedSegmentColCompareTestCheck1::checkCallBack(const Alignment *alignment) {
...
void MappedSegmentColCompareTestCheck2::checkCallBack(const Alignment *alignment) {
    MappedSegmentColCompareTest::checkCallBack(alignment);
}
