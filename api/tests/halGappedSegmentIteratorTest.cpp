...
void GappedSegmentSimpleIteratorTest::checkCallBack(const Alignment *alignment) {
...
void GappedSegmentSimpleIteratorTest2::checkCallBack(const Alignment *alignment) {
    const Genome *child = alignment->openGenome("child");
    const Genome *parent = alignment->openGenome("parent");
...
void GappedSegmentIteratorIndelTest::checkCallBack(const Alignment *alignment) {
    const Genome *child = alignment->openGenome("child");
    const Genome *parent = alignment->openGenome("parent");
