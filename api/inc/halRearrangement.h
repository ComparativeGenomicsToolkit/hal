...
namespace hal {
    ...
    class Rearrangement {
      public:
        ...
        /* constructor */
        Rearrangement(const Genome *childGenome, hal_size_t gapThreshold = DefaultGapThreshold,
                      double nThreshold = DefaultNThreshold, bool atomic = false);
        ...
        virtual bool identifyFromLeftBreakpoint(TopSegmentIteratorPtr topSegment);

        /** Test if segment at given index corresponds to a deletion
         * (shortcut method used by column iterator) */
        virtual bool identifyDeletionFromLeftBreakpoint(TopSegmentIteratorPtr topSegment);
         ...
         * before an insertion
         * (shortcut method used by column iterator) */
        virtual bool identifyInsertionFromLeftBreakpoint(TopSegmentIteratorPtr topSegment);
      ...
      private:
        ...
        GappedBottomSegmentIteratorPtr _leftParent, _curParent, _nextParent, _rightParent;
