...
namespace hal {
    ...
    class SegmentedSequence {
      public:
         ...
         * @param position Index in segment array of returned iterator */
        virtual TopSegmentIteratorPtr getTopSegmentIterator(hal_index_t position = 0) const = 0;
         ...
         * @param position Index in segment array of returned iterator */
        virtual BottomSegmentIteratorPtr getBottomSegmentIterator(hal_index_t position = 0) const = 0;
        ...
        virtual ColumnIteratorPtr getColumnIterator(const std::set<const Genome *> *targets = NULL,
                                                    ...
                                                    bool onlyOrthologs = false, bool novel = false,
                                                    bool noRefDupes = false) const = 0;
        ...
        virtual RearrangementPtr getRearrangement(hal_index_t position, hal_size_t gapLengthThreshold, double nThreshold,
        ...
        virtual GappedTopSegmentIteratorPtr getGappedTopSegmentIterator(hal_index_t i, hal_size_t gapThreshold,
                                                                        bool atomic = false) const = 0;
         ...
         * get the last iterator from a sequence  (not a big deal since
         * the functinality is already in the implementation (extendLeft)*/
        virtual GappedBottomSegmentIteratorPtr getGappedBottomSegmentIterator(hal_index_t i, hal_size_t childIdx,
