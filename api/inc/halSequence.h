    ...
    class Sequence {
      public:
        ...
        struct Info {
            ...
            Info(const std::string &name, hal_size_t length, hal_size_t numTopSegments, hal_size_t numBottomSegments)
                : _name(name), _length(length), _numTopSegments(numTopSegments), _numBottomSegments(numBottomSegments) {
            }
            std::string _name;
            hal_size_t _length;
        ...
        struct UpdateInfo {
            ...
            UpdateInfo(const std::string &name, hal_size_t numSegments) : _name(name), _numSegments(numSegments) {
            }
            std::string _name;
