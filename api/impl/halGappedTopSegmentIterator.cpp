...
{
  assert(leftTopSegIt->hasParent() && rightTopSegIt->hasParent());
  ...
  if (leftTopSegIt->hasNextParalogy() != rightTopSegIt->hasNextParalogy())
  {
    return false;
  }
  ...
  if (leftTopSegIt->hasNextParalogy() == true)
  {
