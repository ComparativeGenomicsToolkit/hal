 ...
 * All rights reserved.                                                      *
 *                                                                           *
 * This file is part of YOMO.  The full YOMO copyright notice, including     *
 * terms governing use, modification, and redistribution, is contained in    *
 * the files COPYING and Copyright.html.  COPYING can be found at the root   *
 * of the source code distribution tree; Copyright.html can be found at the  *
 * root level of an installed copy of the electronic YOMO document set and   *
 * is linked from the top-level documents page.  It can also be found at     *
 * http://hdfgroup.org/YOMO/doc/Copyright.html.  If you do not have          *
 ...
 * determine the amount of yomo address space in use and the high-water mark
...
// YOMO change the type for flush function for 10.0.0 release, then change it back
 ...
 *
 * Purpose:  Create and/or opens a Standard C file as an YOMO file.
 *
 * Errors:
 ...
 *    called shortly after an existing YOMO file is opened in order
 *    to tell the driver where the end of the YOMO data is located.
 *
 * Return:  Success:  0
 *
 ...
 *    either the Unix end-of-file or the YOMO end-of-address
 *    markers.
 *
 ...
 * It is added here to trigger warning if YOMO private definitions are included
 * by mistake.  The code should use only YOMO public API and definitions.
 */
#error "Do not use YOMO private definitions"
#endif
}
