...
void Hdf5ExternalArray::create(PortableH5Location *file, const H5std_string &path, const DataType &dataType,
...
void Hdf5ExternalArray::load(PortableH5Location *file, const H5std_string &path, hsize_t chunksInBuffer) {
