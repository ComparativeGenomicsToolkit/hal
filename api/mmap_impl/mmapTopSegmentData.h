...
namespace hal {
    class MMapTopSegmentData {
      public:
        void setStartPosition(hal_index_t startPosition) {
            _startPosition = startPosition;
        };
        void setBottomParseIndex(hal_index_t parseIndex) {
            _bottomParseIndex = parseIndex;
        };
        void setNextParalogyIndex(hal_index_t paralogyIndex) {
            _paralogyIndex = paralogyIndex;
        };
        void setParentIndex(hal_index_t parentIndex) {
        ...
        hal_index_t getNextParalogyIndex() const {
            return _paralogyIndex;
        };
        hal_index_t getParentIndex() const {
            return _parentIndex;
        };
        hal_index_t getReversed() const {
            return _reversed;
        };
