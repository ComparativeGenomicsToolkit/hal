...
public:
   MMapMetaData(MMapAlignment *alignment) : 
        ...
        _offset(_alignment->allocateNewArray(sizeof(MMapMetaDataData))),
   ...
   MMapMetaData(MMapAlignment *alignment, size_t offset) :
        ...
        _offset(offset),
        _data((MMapMetaDataData *) _alignment->resolveOffset(_offset, sizeof(MMapMetaDataData))),
        _keys(_alignment, _data->_keysOffset),
        _values(_alignment, _data->_valuesOffset),
        _dirty(false) {
            read();
        };
   ~MMapMetaData() { if (_dirty) { write(); } };
